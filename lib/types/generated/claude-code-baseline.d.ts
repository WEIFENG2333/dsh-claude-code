...
export declare const CLAUDE_CODE_BASELINE: {
    readonly capturedVersion: "2.1.234.f09";
    readonly requestPath: "/v1/messages?beta=true";
    readonly system: readonly [{
        readonly type: "text";
        readonly text: "x-anthropic-billing-header: cc_version=2.1.234.f09; cc_entrypoint=sdk-cli;";
    }, {
        readonly type: "text";
    ...
    readonly tools: readonly [{
        ...
        readonly input_schema: {
            ...
            readonly properties: {
                readonly action: {
                    readonly type: "string";
                    readonly enum: readonly ["list", "get", "create", "update", "run", "create_webhook_trigger", "list_runs", "get_run_log"];
                };
                readonly trigger_id: {
                    readonly description: "Required for get, update, run, and list_runs";
                    readonly type: "string";
                    readonly pattern: "^[\\w-]+$";
                };
                readonly session_id: {
                    readonly description: "Required for get_run_log: a run session id (cse_… or session_…, from list_runs)";
                    readonly type: "string";
                    readonly pattern: "^[\\w-]+$";
                };
                readonly cursor: {
                    readonly description: "next_cursor from a previous list_runs or get_run_log page";
                    readonly type: "string";
                    readonly maxLength: 1024;
                };
                readonly body: {
                    readonly description: "Required for create and update; optional for run";
                    readonly type: "object";
